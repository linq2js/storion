...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Storion - Reactive State Management' }],
    ['meta', { property: 'og:description', content: 'Type-safe. Auto-tracked. Effortlessly composable.' }],
  ],
  ...
  themeConfig: {
      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'useLocalStore', link: '/guide/react/use-local-store' },
      ...
      '/api/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'useLocalStore()', link: '/api/use-local-store' },
    ...
    editLink: {
      pattern: 'https://github.com/linq2js/storion/edit/main/packages/docs/:path',
