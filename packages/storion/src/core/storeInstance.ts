/**
 * Store Instance - Creates and manages store instances.
 *
 * Handles state management, subscriptions, actions, and lifecycle.
 */
...
import { generateStoreId } from "./generator";
...
>(
  ...
  instance = {
    ...
    dispose() {
      ...
      // Notify disposal listeners (including child store disposals)
      disposeEmitter.emit();
    },
